...
import hp2 from "../../assets/Muskan_Profile.jpg"
...
const Home = ({ scrollRef }) => {
  ...
  const handleButton = () => {
    // const downloadLink = 'https://drive.google.com/uc?export=download&id=16F5emhw_slWpQijxoWlW0_jcX_Guwysb';
    // window.open(downloadLink, '_blank');
  };

const handleDownload = () => {
  const downloadLink = 'https://drive.google.com/file/d/16F5emhw_slWpQijxoWlW0_jcX_Guwysb/view';
    ...
    <div ref={scrollRef}>
      ...
      >
        ...
        >
          ...
          <a href='https://drive.google.com/uc?export=download&id=16F5emhw_slWpQijxoWlW0_jcX_Guwysb' onClick={handleDownload}   className={styles.resumeBtn}
          rel="noreferrer" download='https://drive.google.com/uc?export=download&id=16F5emhw_slWpQijxoWlW0_jcX_Guwysb' id="resume-button-1" >
            <Button
              text={
